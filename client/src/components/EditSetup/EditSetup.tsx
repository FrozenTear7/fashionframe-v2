...
const EditSetup: React.VFC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Edit setup | Fashionframe</title>
        <meta name="description" content="Edit a created fashion setup." />
        <meta
          name="keywords"
          content="fashionframe, warframe, fashion, setup, setups, create, color, colors, colorpicker, picker, edit, edition, social, hub, sharing"
        />
      </Helmet>
      TODO
    </>
